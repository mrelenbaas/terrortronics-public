...
IntentHelper::IntentHelper(struct android_app *app)
  ...
  add_flags_mid_ = GET_METHOD_ID(true, intent_cls_, "addFlags",
                                 "(I)Landroid/content/Intent;");
  add_category_mid_ =
      GET_METHOD_ID(true, intent_cls_, "addCategory",
                    "(Ljava/lang/String;)Landroid/content/Intent;");
  set_type_mid_ = GET_METHOD_ID(true, intent_cls_, "setType",
                                "(Ljava/lang/String;)Landroid/content/Intent;");
  set_data_mid_ = GET_METHOD_ID(true, intent_cls_, "setData",
                                "(Landroid/net/Uri;)Landroid/content/Intent;");
  set_action_mid_ =
      GET_METHOD_ID(true, intent_cls_, "setAction",
                    "(Ljava/lang/String;)Landroid/content/Intent;");
  set_package_mid_ =
      GET_METHOD_ID(true, intent_cls_, "setPackage",
                    "(Ljava/lang/String;)Landroid/content/Intent;");
  put_extra_strarray_mid_ = GET_METHOD_ID(
      true, intent_cls_, "putExtra",
      "(Ljava/lang/String;[Ljava/lang/String;)Landroid/content/Intent;");
  put_extra_int_mid_ =
      GET_METHOD_ID(true, intent_cls_, "putExtra",
  ...
  new_component_mid_ = GET_METHOD_ID(true, cls, "<init>",
                                     "(Ljava/lang/String;Ljava/lang/String;)V");
  set_component_mid_ = GET_METHOD_ID(
      true, intent_cls_, "setComponent",
      "(Landroid/content/ComponentName;)Landroid/content/Intent;");
  send_broadcast_mid_ = GET_METHOD_ID(true, context_, "sendBroadcast",
                                      "(Landroid/content/Intent;)V");
  start_activity_mid_ = GET_METHOD_ID(true, context_, "startActivity",
                                      "(Landroid/content/Intent;)V");
  jni_scope->DeleteLocalRef(cls);
  ...
  uri_parse_mid_ = GET_STATIC_METHOD_ID(
      true, uri_cls_, "parse", "(Ljava/lang/String;)Landroid/net/Uri;");
}
...
IntentHelper &IntentHelper::PutExtra(
    const std::string &key_str,
    const std::vector<std::string> &value_str_array) {
  ScopedJNIAttach jni_scope(vm_);
  jstring key = jni_scope->NewStringUTF(key_str.c_str());
  jobjectArray value = (jobjectArray)jni_scope->NewObjectArray(
      value_str_array.size(), jni_scope->FindClass("java/lang/String"),
...
IntentHelper &IntentHelper::SetComponent(const std::string &pkg_name_str,
  ...
  jobject component_name_obj =
      NEW_OBJECT(true, component_cls_, new_component_mid_, pkgName, clsName);
  CALL_VOID_METHOD(true, component_name_obj, new_component_mid_, pkgName,
                   clsName);
...
void IntentHelper::StartActivity(const std::string &activity_str) {
  ...
  jmethodID mid =
      GET_METHOD_ID(true, cls, "startActivity", "(Landroid/content/Intent;)V");
