...
{
    AZ_COMPONENT_IMPL(WindowPositionEditorSystemComponent, "WindowPositionEditorSystemComponent",
        WindowPositionEditorSystemComponentTypeId, BaseSystemComponent);
